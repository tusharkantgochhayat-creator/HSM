...
.text-primary {
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-home-li
    st">
  ...
  <?php if(($row['userStatus']==1) && ($row['doctorStatus']==1)) { ?>
      <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
         onClick="return confirm('Are you sure you want to cancel?')" title="Cancel">
         <button class="btn btn-danger">Cancel</button></a>
      
      <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&close=update" 
         onClick="return confirm('Are you sure you want to close this appointment?')" title="Close">
         <button class="btn btn-primary">Mark Closed</button></a>
  ...
  <?php } else if($row['doctorStatus']==2) {
      echo "Already Prescribed";
  } else {
      echo "-";
  } ?>
</td>
